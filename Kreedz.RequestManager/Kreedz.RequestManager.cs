...
using SqlSugar;
using Kreedz.RequestManager.Replay;
using Kreedz.RequestManager.Storage;

namespace Kreedz.RequestManager;

public class SqlRequestManager : IModSharpModule
{
    private const string TimerConfigFileName            = "kreedz.jsonc";
    private const string TimerConfigDirectoryName       = "configs";
    private const string ConnectionStringKey            = "Timer";
    private const string ModuleConnectionStringKey      = "Kreedz.RequestManager";
    ...
    string IModSharpModule.DisplayName   => "[Kreedz] RequestManager - SQL";

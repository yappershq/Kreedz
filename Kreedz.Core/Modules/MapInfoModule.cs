...
internal class MapInfoModule : IModule, IMapInfoModule, IGameListener
{
    ...
    [
        ...
        // cs2kz.cfg — the KZ-environment set (verbatim from KZGlobalteam/cs2kz-metamod/cfg/cs2kz.cfg),
        // executed at map start. Makes CS2 behave as KZ: no damage/death/money/rounds/warmup.
        "sv_party_mode false",
        "game_type 3",
        "game_mode 0",
        ...
        "mp_disconnect_kills_players false",

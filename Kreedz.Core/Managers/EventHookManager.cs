...
using FireEventCallback = Kreedz.Managers.IEventHookManager.DelegateOnEventFired;
using HookEventCallback
    = System.Func<Kreedz.Managers.EventHookParams, Sharp.Shared.Types.HookReturnValue<bool>>;
